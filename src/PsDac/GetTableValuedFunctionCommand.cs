...
namespace PsDac
{
    [Cmdlet(VerbsCommon.Get, "TableValuedFunction")]
    [OutputType(typeof(TSqlObject))]
    public class GetTableValuedFunctionCommand : PSCmdlet
    {
        [Parameter(
            Position = 0,
            Mandatory = true,
        ...
        protected override void ProcessRecord()
        {
            ...
            foreach (var item in Model.GetObjects(DacQueryScopes.Default, ModelSchema.TableValuedFunction)) {
