...
Module Name: PsDac
online version: https://abbgrade.github.io/PsDac/Get-DacView.html
schema: 2.0.0
---
...
```
Get-DacView [-Model] <TSqlModel> [[-Name] <String>] [-ProgressAction <ActionPreference>] [<CommonParameters>]
```
