...
Module Name: PsDac
online version: https://abbgrade.github.io/PsDac/Get-DacPartitionScheme.html
schema: 2.0.0
---

# Get-DacPartitionScheme

## SYNOPSIS
Gets the partition schemes of a model.
...
### -Model
Specifies the model to get the partition schemes from.
